...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#444140;font-size:1.2em; opacity:0.8;">
		 <div class="container-fluid">
		 	<div class="navbar-header">
		 		...
		 		<a class="navbar-brand" href="#"><i class="fa fa-power-off" style="color: white;"></i></a>
		 		...
		 		<div class="collapse navbar-collapse" id="navbar-collapse-main">
		 			<ul class="nav navbar-nav navbar-right" >
		 				...
		 				<li><a  href="#" style="color: white;">Blood Donation</a></li>
	...
	<div class="home" style="position: relative; margin: 0 auto;">
 			<center>	<img src="images/view.jpg" class="responsive" style=" width: 100%;
  height: auto;"></center>
